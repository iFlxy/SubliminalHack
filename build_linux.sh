...
build_application() {
    ...
    pyinstaller --windowed --onefile "$script_name" --distpath "$output_dir" --hidden-import PyQt5.sip
...
main() {
    ...
    echo "WARNING: The Linux build script is currently broken (audio doesn't play), use the .py file instead."
